...
- We are gonna focus on stabilizing the pendulum with the PID parameters and working on the challenges
...
![Output Response Curve](../visuals/figures/OutputResponseCurve.png)
- Angle sensor works
