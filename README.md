...
- ![OutputResponseCurve](visuals/figures/OutputResponseCurve.png) The outputResponseCurve is generated by [dataOutputResponseCurve.py](code/Python/dataOutputResponseCurve.py). All the measured frequency's are coded into the file since we didnt have a pyserial connection yet. 
