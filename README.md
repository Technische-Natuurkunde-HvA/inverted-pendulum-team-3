...
- The outputResponseCurve ![OutputResponseCurve](visuals/figures/OutputResponseCurve.png) is generated by [dataOutputResponseCurve.py](code/Python/dataOutputResponseCurve.py). All the measured frequency's are coded into the file since we didnt have a pyserial connection yet. 
...
- [upside_down_data](data/DataUpsideDownFinal.csv)
...
- [Demonstartion of the upside down challenge](visuals/videos/UpsideDownDemonstratie.mp4)
