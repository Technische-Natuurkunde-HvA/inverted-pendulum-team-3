...
- We found out that our flywheel was too small and heavy. So we designed a new flywheel and printed it out. When we tested the new flywheel it lifted for the first time.
- We made a PID controller using the PID_V1 library and compared it to the one on GitHub (https://github.com/br3ttb/Arduino-PID-Library/blob/master/examples/PID_Basic/PID_Basic.ino). We saw that they were nearly identical. 
- We found an issue with working on the main branch we fixed it by manually merging the different versions of files.
...
### week 4
- We balanced the pendulum for the first time using a PID.
- We improved the PID parameters.
...
- We implemented the logic into our code and tweaked it.
- We did the upside down challenge succesfully.
